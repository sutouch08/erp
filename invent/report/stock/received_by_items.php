<div class="container">
  ...
  <div class="row">
    <div class="col-sm-1 col-1-harf padding-5 first">
      ...
      <div class="btn-group width-100">
        <button type="button" class="btn btn-sm width-50 btn-primary" id="btn-all" onclick="toggleItems(1)">ทั้งหมด</button>
        <button type="button" class="btn btn-sm width-50" id="btn-range" onclick="toggleItems(0)">ระบุ</button>
      </div>
    </div>
    <div class="col-sm-2 padding-5">
      <label>เริ่มต้น</label>
      <input type="text" class="form-control input-sm text-center" id="txt-from-pd" disabled />
    </div>
    <div class="col-sm-2 padding-5">
      <label>สิ้นสุด</label>
      <input type="text" class="form-control input-sm text-center" id="txt-to-pd" disabled />
    </div>
    <div class="col-sm-2 padding-5">
  ...
  <input type="hidden" id="allItems" value="1" />
    ...
    {{else}}
      ...
      {{else}}
        <tr>
          ...
          <td class="" style="over-flow-x:hidden;">{{zone}}</td>
...
<script src="script/report/stock/received_by_items.js"></script>
