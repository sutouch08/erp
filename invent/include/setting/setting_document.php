<div class="tab-pane fade" id="document">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_RECIEVE" value="<?php echo getConfig('PREFIX_RECEIVE'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_RECIEVE" value="<?php echo getConfig('RUN_DIGIT_RECEIVE'); ?>" /></div>
                  <div class="divider-hidden"></div>
                  ...
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_RETURN" value="<?php echo getConfig('PREFIX_RETURN_ORDER'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_RETURN" value="<?php echo getConfig('RUN_DIGIT_RETURN_ORDER'); ?>" /></div>
                  <div class="divider-hidden"></div>
                  ...
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_TRANFER" id="preTransfer" value="<?php echo getConfig('PREFIX_TRANSFER'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_TRANFER" id="preTransfer" value="<?php echo getConfig('RUN_DIGIT_TRANSFER'); ?>" /></div>
                  <div class="divider-hidden"></div>

                  <div class="col-sm-4"><span class="form-control left-label">ปรับยอดสต็อก</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_ADJUST" id="preAdjust" value="<?php echo getConfig('PREFIX_ADJUST'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_ADJUST" id="preAdjust" value="<?php echo getConfig('RUN_DIGIT_ADJUST'); ?>" /></div>
                  <div class="divider-hidden"></div>

                  <div class="col-sm-4"><span class="form-control left-label">นโยบายส่วนลด</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_POLICY" id="prePolicy" value="<?php echo getConfig('PREFIX_POLICY'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_POLICY" id="prePolicy" value="<?php echo getConfig('RUN_DIGIT_POLICY'); ?>" /></div>
                  <div class="divider-hidden"></div>

                  <div class="col-sm-4"><span class="form-control left-label">เงื่อนไขส่วนลด</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line prefix" name="PREFIX_RULE" id="preRule" value="<?php echo getConfig('PREFIX_RULE'); ?>" /></div>
                  <div class="col-sm-2"><span class="form-control left-label">Run digit</span></div>
                  <div class="col-sm-2"><input type="text" class="form-control input-sm input-mini input-line digit" name="RUN_DIGIT_RULE" id="preRule" value="<?php echo getConfig('RUN_DIGIT_RULE'); ?>" /></div>
                  <div class="divider-hidden"></div>
