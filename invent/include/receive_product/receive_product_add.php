...
<div class="row">
	<div class="col-sm-1">
    	<label>เล่ม</label>
        <label class="form-control input-sm text-center" disabled><?php echo getConfig("BOOKCODE_BI"); ?></label>
    </div>
    <div class="col-sm-2">
	...
	<div class="col-sm-2">
        ...
        <input type="text" class="form-control input-sm text-center" name="dateAdd" id="dateAdd" placeholder="ระบุวันที่เอกสาร" value="<?php echo date('d-m-Y'); ?>" />
...
<div class="row">
    ...
    <input type="hidden" name="id_receive_product" id="id_receive_product" />
