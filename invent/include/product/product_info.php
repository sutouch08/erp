...
<!-------------------------------------------------------  ข้อมูลสินค้า  ----------------------------------------------------->
            ...
            <form id="productForm">
            	<div class="row">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control input-sm input-mini" style="position:relative; float:left; margin-right:5px;" name="discount" id="discount" value="<?php echo showDiscount($rs->discount_amount, $rs->discount_percent); ?>" />
                    <select class="form-control input-sm input-mini inline" name="discountType" id="discountType">
                        <option value="percent" <?php echo isSelected( 'percent', discountType($rs->discount_amount, $rs->discount_percent ) ); ?>>เปอร์เซ็นต์</option>
                        <option value="amount" <?php echo isSelected('amount', discountType($rs->discount_amount, $rs->discount_percent ) ); ?>>จำนวนเงิน</option>
                     </select>
                     <span id="discount-error" class="label-left red" style="margin-left:15px; display:none;"></span>
                    </div>
                    <div class="divider-hidden" style="margin-top:5px; margin-bottom:5px;"></div>
