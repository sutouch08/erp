...
<?php
	...
	//echo "SELECT tbl_order.*, invoice FROM tbl_order JOIN tbl_order_invoice ON tbl_order.id_order = tbl_order_invoice.id_order " . $where . " LIMIT ". $paginator->Page_Start .", ". $paginator->Per_Page;
?>		
<div class='row'>
<div class='col-sm-12'>
