   ...
   <form id="mobile_form_filter">
    <div class="container" style="padding-left:7%;padding-right: 7%">
      ...
      <div class="row" style="padding-right:10px;padding-left: 10px">
        <br>
        <div id="slider_modal" ></div><br>
        <CENTER> 
          <h3><span>ราคาต่ำสุด :</span><span id="slider-snap-value-lower-modal"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span>ราคาสูงสุด :</span><span id="slider-snap-value-upper-modal"></span></h3>
        </CENTER>
        <input type="text" name="minPrice" id="minPrice_Modal" class="hidden" value="0">
        <input type="text" name="maxPrice" id="maxPrice_Modal" class="hidden" value="10000">
      </div> 
      <button id="mobile_btn_smt_filter" class="btn btn-block btn-primary">ตกลง</button>
    </div>
  </div> 
</div>
...
$("#mobile_btn_smt_filter").click(function(e){
  $( "#mobile_form_filter" ).submit();
}); 
...
function closeNav() {
  $("#myNav").css('width', '0%');
  $(".header-main").show(function(){$("#btn_filter").show()});
