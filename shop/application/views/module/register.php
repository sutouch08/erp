								...
								<div class="form-group" style="margin-top:35px;margin-bottom:35px">
									<div>
										...
										<div class="form-group">
											...
											<label for="Subdistrict" class="error"></label>
										</div>
...
$("#Proviance").change(function(){
	$.ajax({
		...
		// console.log(jd); 
			var opt="";
			$.each($.parseJSON(jd), function(key, val){
...
jQuery(function ($) {
	$('#form').validate({
        ...
        messages:{
            ...
            District:{
            	selectcheck: "กรุณาเลือกอำเภอ",
            },
            Subdistrict:{
            	selectcheck: "กรุณาเลือกตำบล",
            },
            Postcode:{
            	selectcheck: "กรุณาเลือกรหัสไปรษณีย์",
            }
        },
